...
// Synthesize input events: type a string, fire a hotkey, scroll, click.
// Reuses HotkeyRegistry's keycode map. All events post to the session tap
// (kCGSessionEventTap) so they target the user's foreground app.
