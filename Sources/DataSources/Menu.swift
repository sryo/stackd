...
//
// Backs sd.menu.popup. Separate from Menubar.swift — that file owns the
// system MENU BAR (NSStatusBar.system, CGSSetMenuBarVisibility); this one
// only deals with transient context menus at the cursor.
enum PopupMenu {
